    ...
    public partial class Pay_windowForm : Standard_Window_Layout
    {
        ...
        private void ProductsHasBeenBought()
        {
            ...
            if (ProductsPaid != null)
            {
                ...
                PrinterInfo.MethodThatPrints(ActiveTable.Table_name, ActiveEmployee.EmployeeName, BoughtProducts, TotalToPrint, "Microsoft Print to PDF");  /*Change the name of printer where receipt is printed*/
                BoughtProducts = new List<ReceiptProduct>();
                PaidAmount = 0;
