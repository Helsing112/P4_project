...
namespace ConsoleApplication5
{
    public partial class Main_page : Form
    {
        ...
        public Main_page(string library_path)
        {
            ...
            Size_of_table_panel = new Size(500, this.Height); //The size of the table panel, used as parameter for both the manager and the mainpage_panel
        ...
        /// <summary>
        /// This partial method should contain all initializations of field controls that should be reused
        /// </summary>
        private void Initialize_Field_Controls()
        {
            Initialize_Field_Controls_startPage();
            Initialize_Field_Controls_tablesPage();
            Initialize_Field_Controls_ProductAdderPage();
